...
struct AlignedBlockFace
{
	...
	uint32_t ao : 8;					// 12-19: Ambient occlusion
	uint32_t textureID : 9;				// 20-28: Texture ID
	...
	AlignedBlockFace(uint32_t x, uint32_t y, uint32_t z, uint32_t ao, uint32_t textureID, uint32_t textureTransformation, uint32_t light);
};