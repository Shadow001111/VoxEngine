...
constexpr int CHUNK_REGION_SIZE = 4;
constexpr int CHUNK_REGION_VOLUME = CHUNK_REGION_SIZE * CHUNK_REGION_SIZE * CHUNK_REGION_SIZE;
constexpr int CHUNK_REGION_SIZE_LOG2 = 2;
constexpr int CHUNK_REGION_LOWER_BITS_MASK = CHUNK_REGION_SIZE - 1;

static_assert(CHUNK_REGION_SIZE == (1 << CHUNK_REGION_SIZE_LOG2), "CHUNK_REGION_SIZE_LOG2 is wrong");